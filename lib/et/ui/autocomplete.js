/*!require: hacks , et.dom , et.ui , jquery.dropTo */
/*
...
(function(et, $){
	...
	var maxHeightProp = ($.browser.msie && $.browser.version <= 7)?'height':'max-height';
    var ctor = function(options){
		...
		if (this._options.inputHtml == null ||
        ...
        this._input = this._dom.find('input').addClass(this._options.inputClass);
    ...
    */
    ...
    p._resizeResult = function(){
		...
		var cssObj = {};
		cssObj[maxHeightProp] =  box.clientHeight - offset.top + box.bodyScrollTop - 6;
