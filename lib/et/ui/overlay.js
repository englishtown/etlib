/*!require: et.dom , et.ui , et.ui.overlayController, jquery.support */
/*
Ctor: et.ui.overlay
    ...
    ctor.prototype = {
        _init: function () {
            ...
            */
            ...
            /*
                If the device is Mobile(Iphone or Ipad or Android etc.) or isFixed is true, we set position: absolute,
            ...
            */
            regMobile = /(mobile)/gi;
            if(regMobile.test(window.navigator.userAgent) || this._options.isFixed){
