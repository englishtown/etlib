...
TODO:
    1 firefox 4 masking effect
    2 use onpropertychange and DOMAttrModified to watch changes on targeting element.
...
!function ($) {
	...
	p._setGlidee = function () {
		...
		var curScrollPos = this.opts.target.scrollTop();
		
		// refresh it , 
		// make content scroll into view, when content is small enough to not to generate scrollbar, 
		// normal browser will set scrollTop=0 but firefox sometime not.
        this.opts.target.scrollTop(curScrollPos);
