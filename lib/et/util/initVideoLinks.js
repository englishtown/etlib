...
(function (et, $) {
	...
	function showVideo(content, noFlash, link){
		...
		if (swfobject.getFlashPlayerVersion().major > 0 || (jQuery.support.html5Video && link.indexOf('youtube.com') > 0)){
            ...
            if (jQuery.support.html5Video){
                ...
                videoIframe = $('<iframe id="' + idbakup + '" class="youtube-player et_video_placeHolder"' +
                    ' type="text/html" src="http://www.youtube.com/embed/' + videoId + '?autoplay=1" frameborder="0"></iframe>');
